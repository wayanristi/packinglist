...
<div class="container mt-4">
    <h3>Tambah Nomor Kontrak KHS</h3>
    <form id="formKontrak" class="mt-3">
        <div class="mb-3">
            <label for="nomor_kontrak" class="form-label">Nomor Kontrak KHS</label>
            <input type="text" name="nomor_kontrak" id="nomor_kontrak" class="form-control" placeholder="Masukkan Nomor Kontrak" required>
        </div>
